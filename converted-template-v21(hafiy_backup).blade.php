...
<head>
    ...
    <style>
        ...
        * {
        ...
        :root {
            --primary: #614051;
            --primary-light: #8B6F7E;
            --primary-dark: #3D2635;
            --accent: #9B7E8C;
            --secondary: #F5F0F3;
            --background: linear-gradient(135deg, #F5F0F3 0%, #E8DDE4 100%);
            --text-dark: #2C1E26;
            --text-light: #fff;
            --transition: all 0.4s cubic-bezier(0.4, 0, 0.2, 1);
            --shadow-sm: 0 2px 8px rgba(97, 64, 81, 0.08);
            --shadow-md: 0 4px 16px rgba(97, 64, 81, 0.12);
            --shadow-lg: 0 8px 32px rgba(97, 64, 81, 0.16);
        }
        ...
        .video-overlay-content {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(135deg, rgba(61,38,53,0.4) 0%, rgba(97,64,81,0.3) 50%, rgba(61,38,53,0.4) 100%);
            z-index: 2;
            display: flex;
        ...
        .paper-container {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(135deg, #F5F0F3 0%, #E8DDE4 50%, #D4C5D0 100%);
            z-index: 10000;
        ...
        .paper-door {
            ...
            height: 100%;
            width: 50%;
            background: linear-gradient(135deg, #ffffff 0%, #FAF7F9 50%, #F5F0F3 100%);
            border: 1px solid rgba(97, 64, 81, 0.1);
            transition: transform 1.8s cubic-bezier(0.4, 0.0, 0.2, 1);
            box-shadow:
                0 0 20px rgba(97, 64, 81, 0.12),
        ...
        .paper-door.left {
            ...
            border-right: 1px solid rgba(97, 64, 81, 0.15);
            background: linear-gradient(90deg, #ffffff 0%, #FAF7F9 80%, #F5F0F3 100%);
        ...
        .paper-door.right {
            ...
            border-left: 1px solid rgba(97, 64, 81, 0.15);
            background: linear-gradient(90deg, #F5F0F3 0%, #FAF7F9 20%, #ffffff 100%);
        ...
        .center-button {
            ...
            width: 260px;
            height: 170px;
            background: linear-gradient(145deg, #ffffff 0%, #FAF7F9 100%);
            border-radius: 85px;
            display: flex;
            flex-direction: column;
            align-items: center;
            ...
            box-shadow:
                0 12px 40px rgba(97, 64, 81, 0.15),
                0 6px 20px rgba(97, 64, 81, 0.1),
                inset 0 1px 0 rgba(255, 255, 255, 0.9);
            transition: all 0.4s cubic-bezier(0.4, 0, 0.2, 1);
            border: 2px solid rgba(97, 64, 81, 0.1);
        }

        .center-button:hover {
            transform: translateY(-50%) scale(1.08);
            box-shadow:
                0 16px 50px rgba(97, 64, 81, 0.2),
                0 8px 25px rgba(97, 64, 81, 0.15),
        ...
        .center-button .couple-names {
            ...
            text-align: center;
            line-height: 1.2;
            text-shadow: 0 2px 4px rgba(97, 64, 81, 0.1);
        }
        ...
        .floating-menu {
            ...
            flex-direction: column;
            align-items: center;
            border: 1px solid rgba(97, 64, 81, 0.15);
            backdrop-filter: blur(10px);
        ...
        .menu-item {
            ...
            border: 2px solid rgba(97, 64, 81, 0.15);
            cursor: pointer;
            transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);
        ...
        .countdown {
            background: linear-gradient(135deg, rgba(97, 64, 81, 0.05), rgba(245, 240, 243, 0.95));
            padding: 90px 0;
            border-top: 1px solid rgba(97, 64, 81, 0.15);
            border-bottom: 1px solid rgba(97, 64, 81, 0.15);
        }
        ...
        .countdown-item::before {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(90deg, transparent, rgba(97, 64, 81, 0.08), transparent);
        ...
        .petal:nth-child(odd) {
            background: rgba(155, 126, 140, 0.7);
        ...
        .couple {
            ...
            border-top: 1px solid rgba(97, 64, 81, 0.2);
            border-bottom: 1px solid rgba(97, 64, 81, 0.2);
        }
        ...
        .photo-frame:hover {
            transform: scale(1.05);
            box-shadow: 0 15px 50px rgba(97, 64, 81, 0.25);
            border-color: var(--primary-dark);
        }
        ...
        /* Events Section */
        .events {
            background-color: rgba(245, 240, 243, 0.3);
            backdrop-filter: blur(0px);
            border-bottom: 1px solid rgba(97, 64, 81, 0.2);
        }
        ...
        .malaysian-wedding-card {
            max-width: 750px;
            margin: 0 auto;
            background: linear-gradient(135deg, rgba(255, 255, 255, 0.98), rgba(250, 247, 249, 0.95));
            border-radius: 25px;
            padding: 3.5rem;
            box-shadow: var(--shadow-lg);
            position: relative;
        ...
        .malaysian-wedding-card:hover {
            ...
            box-shadow: 0 20px 60px rgba(97, 64, 81, 0.2);
        }
        ...
        .location-section {
            background: linear-gradient(135deg, rgba(245, 240, 243, 0.8), rgba(255, 255, 255, 0.9));
            border-radius: 15px;
            padding: 2rem;
            margin: 2rem 0;
        ...
        .qr-placeholder:hover {
            background: rgba(245, 240, 243, 0.8);
        ...
        .messages-scroll {
            ...
            scrollbar-color: rgba(97, 64, 81, 0.5) transparent;
            position: relative;
            z-index: 1;
        }
        ...
        .messages-scroll::-webkit-scrollbar-thumb {
            background: linear-gradient(180deg, var(--primary), rgba(97, 64, 81, 0.7));
            border-radius: 8px;
        ...
        .form-control:focus {
            outline: none;
            border-color: var(--primary);
            box-shadow: 0 0 0 3px rgba(97, 64, 81, 0.1);
            background-color: white;
        }
