    ...
    <style>
        ...
        * {
        ...
        .paper-container {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(135deg, #f8f3e9 0%, #e8dcc0 100%);
            z-index: 10000;
        ...
        .hero-parallax-bg::before {
            ...
            width: 100%;
            height: 100%;
            background-image: url('/asset/background/front_page_vertical.jpg');
        ...
        @media (orientation: landscape) {
            .hero-parallax-bg::before {
                background-image: url('/asset/background/front_page_horizontal.jpg');
            }
        }
        ...
        .parents {
            ...
            margin: 0;
            padding: 0;
            background-image: url('/asset/background/second_page_vertical.jpg');
            background-size: cover;
            background-position: center;
            background-repeat: no-repeat;
            background-attachment: fixed;
        ...
        @media (orientation: landscape) {
            .parents {
                height: 120vh;
                background-image: url('/asset/background/second_page_horizontal.jpg');
            }
        }
        ...
        .messages-scroll {
            ...
            scrollbar-color: rgba(200, 161, 101, 0.5) transparent;
            position: relative;
            z-index: 1;
        }
        ...
        .messages-scroll::-webkit-scrollbar-thumb {
            background: linear-gradient(180deg, var(--primary), rgba(200, 161, 101, 0.7));
            border-radius: 8px;
        ...
        <section id="countdown" class="countdown section-reveal">
            <div class="container">
                <div class="countdown-container fade-in">
                    ...
                    <p class="countdown-subtitle">Temani saat-saat manis sebelum kami bersatu dengan lafaz ‘Aku Terima Nikahnya’</p>
                    ...
                    <p class="countdown-message">Tidak sabar untuk merayakan bersama Anda!</p>
                </div>
            </div>
        </section>
                ...
                <div class="container">
                    ...
                    <div class="couple-photos">
                        <div class="couple-photo fade-in-left">
                            ...
                            <p class="couple-desc">Puteri Kepada :</p>
                        ...
                        <div class="couple-photo fade-in-right">
                            ...
                            <p class="couple-desc">Putera Kepada :</p>
