...
<head>
    ...
    <title>Fatimah & Ahmad - Wedding Invitation</title>
...
<body class="invitation-active">
    ...
    <div class="invitation-overlay">
        <div class="envelope">
            ...
            <div class="invitation-content">
                ...
                <h1 class="invitation-couple-names">Ahmad & Fatimah</h1>
                ...
                <p class="wedding-date-small">Wedding Date</p>
            </div>
        </div>
    </div>
    ...
    <section id="hero" class="hero">
        <div class="hero-content">
            ...
            <h1 class="couple-names">Ahmad & Fatimah</h1>
            <p class="wedding-date">WEDDING DATE</p>
            <div class="separator">
            ...
            <div class="couple-photos">
                <div class="couple-photo fade-in-left">
                    <div class="photo-frame">
                            ...
                            <img src="/storage/template-variables/template-var-groom_photo-1750098147.jpg" alt="Groom">
                        
                    </div>
                    <h3 class="couple-name">Abuya bin Abdullah</h3>
                    <div class="separator">
                        <div class="separator-line"></div>
                        <svg viewBox="0 0 24 24">
                            <path d="M12,21.35L10.55,20.03C5.4,15.36 2,12.27 2,8.5C2,5.41 4.42,3 7.5,3C9.24,3 10.91,3.81 12,5.08C13.09,3.81 14.76,3 16.5,3C19.58,3 22,5.41 22,8.5C22,12.27 18.6,15.36 13.45,20.03L12,21.35Z"/>
                    ...
                    <p class="couple-desc">Abdullah Bin Ibrahim & Zainab Binti Ali</p>
                </div>
                <div class="couple-photo fade-in-right">
                    <div class="photo-frame">
                        
                            <img src="/storage/template-variables/template-var-bride_photo-1750098128.jpg" alt="Bride">
                        
                    </div>
                    <h3 class="couple-name">Fatimah binti Rahman</h3>
                    <div class="separator">
                        <div class="separator-line"></div>
                        <svg viewBox="0 0 24 24">
                            <path d="M12,21.35L10.55,20.03C5.4,15.36 2,12.27 2,8.5C2,5.41 4.42,3 7.5,3C9.24,3 10.91,3.81 12,5.08C13.09,3.81 14.76,3 16.5,3C19.58,3 22,5.41 22,8.5C22,12.27 18.6,15.36 13.45,20.03L12,21.35Z"/>
                    ...
                    <p class="couple-desc">Mohammad Bin Hassan & Khadijah Binti Ahmad</p>
                </div>
            </div>
            ...
            <div class="timeline">
                ...
                <div class="timeline-item left fade-in-left">
                    <div class="timeline-content">
                        <p class="event-time">14 Ogos 2024 • 9:00 Pagi</p>
                        <h3 class="event-title">Perkahwinan</h3>
                        <p>A beautiful day</p>
                        ...
                        <div class="event-location">
                            ...
                            <span>DT 9, Jalan Autocity 2, Persiaran Auto City, 75450 Ayer Keroh, Malacca</span>
                        </div>
                ...
                <div class="timeline-item {{ $details['akad_date'] ?? false ? 'right' : 'left' }} fade-in-{{ $details['akad_date'] ?? false ? 'right' : 'left' }}">
                    <div class="timeline-content">
                        <p class="event-time">15 Ogos 2024 • 7:00 Malam</p>
                        <h3 class="event-title">Majlis Bersanding & Reception</h3>
                        <p>The grand celebration featuring the traditional Malaysian wedding throne ceremony, followed by a feast and entertainment.</p>
                        <div class="event-location">
                            <svg width="16" height="16" viewBox="0 0 24 24">
                                <path d="M12,2C8.13,2 5,5.13 5,9C5,14.25 12,22 12,22C12,22 19,14.25 19,9C19,5.13 15.87,2 12,2ZM12,11.5C10.62,11.5 9.5,10.38 9.5,9C9.5,7.62 10.62,6.5 12,6.5C13.38,6.5 14.5,7.62 14.5,9C14.5,10.38 13.38,11.5 12,11.5Z"/>
                            </svg>
                            <span>Dewan Serbaguna</span>
                        </div>
    ...
    <footer>
        <div class="container">
            <div class="footer-content">
                <h2 class="footer-title">Ahmad & Fatimah</h2>
                ...
                @endif
                <p class="copyright">&copy; {{ date('Y') }} Ahmad & Fatimah. All Rights Reserved.</p>
            </div>
        </div>
    </footer>
