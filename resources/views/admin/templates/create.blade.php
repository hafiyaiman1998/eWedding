...
<div class="page-content">
    <div class="page-header">
        <div class="page-header-left">
            ...
            <p class="page-subtitle">Design a new wedding card template</p>
        </div>
    ...
    <div class="form-container">
        <form method="POST" action="{{ route('admin.templates.store') }}" enctype="multipart/form-data" class="template-form">
            @csrf
            ...
            <div class="form-section">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <select id="category" name="category" class="form-select @error('category') error @enderror" required>
                            ...
                            <option value="malaysian" {{ old('category') == 'malaysian' ? 'selected' : '' }}>Malaysian</option>
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" 
                              ...
                              rows="3" 
                              placeholder="Brief description of the template design and style">{{ old('description') }}</textarea>
                    @error('description')
                        <span class="error-message">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="file" 
                               ...
                               accept="image/*">
                        <small class="form-help">Upload a preview image (JPG, PNG, GIF, max 2MB)</small>
                        @error('preview_image')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
                        ...
                        <div class="checkbox-group">
                            <label class="checkbox-label">
                                <input type="checkbox" 
                                       ...
                                       value="1" 
                                       {{ old('is_malaysian_design') ? 'checked' : '' }}>
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <textarea id="blade_template" 
                              ...
                              required>{{ old('blade_template') }}</textarea>
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <textarea id="full_html_template" 
                              ...
                              rows="20" 
                              placeholder="Enter the complete HTML document with CSS, JavaScript, and animations...">{{ old('full_html_template') }}</textarea>
                ...
                <div class="form-group" style="margin-top: 20px;">
                    ...
                    <small class="form-help">
                        Click to automatically detect variables from the <strong>Full HTML Template</strong> above and create default value fields below.
                        ...
                        <br><strong>Image/Video Variables</strong> - Variables containing 'photo', 'image', 'video' etc. will automatically create file upload fields.
            ...
            <div class="form-section" id="defaultVariablesSection" style="display: none;">
                ...
                <input type="hidden" name="default_variables" id="default_variables_json">
...
/* Enhanced responsive adjustments for templates create page */
@media (max-width: 768px) {
    ...
    .form-input, .form-select, .form-textarea, .form-code {
        width: 100%;
        padding: 10px 12px;
