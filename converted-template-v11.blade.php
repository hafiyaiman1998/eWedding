...
<head>
    ...
    <style>
        ...
        * {
        ...
        .countdown {
            background: linear-gradient(135deg, rgba(242, 182, 193, 0.1), rgba(254, 247, 247, 0.8));
            padding: 80px 0;
        ...
        .countdown-item::before {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(90deg, transparent, rgba(242, 182, 193, 0.1), transparent);
